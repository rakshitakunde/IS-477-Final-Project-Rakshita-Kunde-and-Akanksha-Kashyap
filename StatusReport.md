...
IS477 Project/
  ...
  We completed the data collection script (acquire.ipynb). This script uses the requests library to programmatically acquire the two datasets, "Crimes - 2001 to Present" and "Violence Reduction - Victims of Homicides and Non-Fatal Shootings." It automatically creates the ‘data/raw/’ directory as part of our project's storage structure. The result of this step is that the two raw, untouched CSV files have been successfully downloaded and saved locally, making them available for the next stage of the pipeline.
